About azure-mgmt-containerregistry
==================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-mgmt-containerregistry-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6419&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-mgmt-containerregistry-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-mgmt-containerregistry` can be installed with:

```
conda install azure-mgmt-containerregistry
```

It is possible to list all of the versions of `azure-mgmt-containerregistry` available on your platform with:
